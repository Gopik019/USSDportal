...
public class USSD_model2 {
	...
	public JsonObject Find_Menu_details2(Bots001 B1Info, HttpSession session, HttpServletRequest request) {
	 ...
	 try {
		    ...
		    String ADDINFO4 = utils.ReplaceNull(session.getId());   // session id
			...
			System.out.println("Session id "+ADDINFO4);
...
//							}
		...
		public JsonObject Get_data_bots004(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
	{
		...
		public JsonObject Week_Interaction_Session() 
		{
			...
			{			        
				...
				for(int i=0; i<days.size(); i++)
				{
					...
					{
						String day2 = Info.get(j).getDAYS();
		...
		public JsonObject Month_Interaction_Session() 
		{
			...
			try
			{			        
				String sql1 = "SELECT COMMDATE, COUNT(DISTINCT SESSIONID) COUNT FROM bots004 where COMMDATE between To_char(TRUNC(SYSDATE, 'MM'),'DD-MON-YYYY') and To_char(LAST_DAY(TRUNC(SYSDATE)),'DD-MON-YYYY') group by COMMDATE order by COMMDATE";
