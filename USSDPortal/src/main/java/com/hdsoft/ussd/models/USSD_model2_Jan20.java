...
@Component
public class USSD_model2_Jan20 {
		...
		public JsonObject Transfer(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
		{
			...
			JsonObject details = new JsonObject();
				...
				if (SERCODE.equalsIgnoreCase("M00014C") && ( ADDINFO2.equalsIgnoreCase("TZS")|| ADDINFO2.equalsIgnoreCase("USD"))) {
					...
					String sql = "select count(*) from bots004 c where c.mobileno = ? and c.menucd in ('M00014H', 'M0T', 'M00014C') and SESSIONID = (select SESSIONID from (select SESSIONID from bots004 x where x.mobileno = ? order by COMMTIME desc) where rownum = 1) order by COMMTIME";
					 
					int count_ofbots004  = Jdbctemplate.queryForObject(sql, new Object[] {  MOBILENO , MOBILENO  } , Integer.class);
				...
				if (SERCODE.equalsIgnoreCase("M00014C") && ( ADDINFO2.equalsIgnoreCase("TZS")|| ADDINFO2.equalsIgnoreCase("USD"))){  
					...
					{	
							...
							JsonArray js = new JsonArray();
								...
								System.out.println("Destination Acc no - "+Info.get(1).getSELECTCD());
								
							    //Insert_bot003(SUBORGCODE,CHCODE,commdate,MOBILENO,ADDINFO1,Session_Id,commtime,Info.get(0).getMENUCD(),"1",Info.get(0).getSELECTCD()); //Adding Response in bots004 
								...
								System.out.println("Source Acc no - "+Info.get(2).getRESMSG());

							    //Insert_bot003(SUBORGCODE,CHCODE,commdate,MOBILENO,ADDINFO1,Session_Id,commtime,Info.get(2).getMENUCD(),"2",Info.get(2).getRESMSG()); //Adding Response in bots004 
								...
								System.out.println("Transaction Amount - "+Info.get(3).getSELECTCD());
														
							   //Insert_bot003(SUBORGCODE,CHCODE,commdate,MOBILENO,ADDINFO1,Session_Id,commtime,Info.get(3).getMENUCD(),"3",Info.get(3).getSELECTCD()); //Adding Response in bots004 
							    ...
							    //Insert_bot003(SUBORGCODE,CHCODE,commdate,MOBILENO,ADDINFO1,Session_Id,commtime,Info.get(4).getMENUCD(),"4",Info.get(4).getSELECTCD()); //Adding Response in bots004 
