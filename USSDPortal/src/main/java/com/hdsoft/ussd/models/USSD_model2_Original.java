...
@Component
public class USSD_model2_Original {
	...
	public JsonObject Find_Menu_details2(Bots001 B1Info, HttpSession session, HttpServletRequest request) {
	 ...
	 try {
			...
			if(cntofmobileno != 0)               //Registered Mobile No in customer user registration
			{
		...
		//***************************** Interaction Session *********************************//
				...
				public JsonObject Week_Interaction_Session() 
				{
					...
					{	
								...
								List<Bots004dash>  Info = Jdbctemplate.query(sql1, new Bots004dashmapper1());
	  ...
	  public class Bots001Mapper implements RowMapper<Bots001> 
	    {
		   ...
		   public class Bots004dashmapper1 implements RowMapper<Bots004dash> 
		   {
		    	Common_Utils util = new Common_Utils();
