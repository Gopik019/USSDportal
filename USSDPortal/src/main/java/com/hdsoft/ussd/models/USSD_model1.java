...
public class USSD_model1 {
	...
	public JsonObject Find_Menu_details1(Bots001 B1Info, HttpSession session) {
			...
			if(cntofmobileno == 0)               //Non Registered Mobile No in customer user registration
			{
				 if(utils.isNullOrEmpty(SERCODE))
				 {
					 ...
					 //Existing Customer//					
							...
							if (SERCODE.equalsIgnoreCase("M0017") && ADDINFO2.equalsIgnoreCase("Please enter Your Exim Account Number")) {
								flag = true;
								details = Existing_Customer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00018") && ADDINFO2.equalsIgnoreCase("Enter the 4digit PIN") ) {
								flag = true;
								details = Existing_Customer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00MM") && ADDINFO2.equalsIgnoreCase("Enter the Input '0' for main menu") && INPUT.equalsIgnoreCase("0") ) {
								flag = true;
								details = Main_Menu(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M011") && ADDINFO2.equalsIgnoreCase("Balance Inquiry") ) {
								flag = true;
								details = Balance_Inquiry(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M011") && ADDINFO2.equalsIgnoreCase("Recent Transactions") ) {
								flag = true;
								details = Recent_Transactions(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							...
							if (SERCODE.equalsIgnoreCase("M00014") && ADDINFO2.equalsIgnoreCase("Enter the Destination Bank Code") ) {
								flag = true;
								details = Transfer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00014") && ADDINFO2.equalsIgnoreCase("Enter the Destination Account Number") ) {
								flag = true;
								details = Transfer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00014") && ADDINFO2.equalsIgnoreCase("Enter the Transaction Amount") ) {
								flag = true;
								details = Transfer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00014") && ADDINFO2.equalsIgnoreCase("Select the Transaction Currency") ) {
								flag = true;
								details = Transfer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00014C") && ADDINFO2.equalsIgnoreCase("TZS") ) {
								flag = true;
								details = Transfer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00014C") && ADDINFO2.equalsIgnoreCase("USD") ) {
								flag = true;
								details = Transfer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
//							if (SERCODE.equalsIgnoreCase("M00015") && ADDINFO2.equalsIgnoreCase("Enter the Input '1' for confirm the payment") && INPUT.equalsIgnoreCase("1") ) {
//								flag = true;
//								details = Transfer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
//							}	
							if (SERCODE.equalsIgnoreCase("M000013") && ADDINFO2.equalsIgnoreCase("Enter the OTP")) {
								flag = true;
								details = Transfer(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}	
							if (SERCODE.equalsIgnoreCase("M011") && ADDINFO2.equalsIgnoreCase("Cheque Book Request") && INPUT.equalsIgnoreCase("4") ) {
								flag = true;
								details = Cheque_Book_Request(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0013") && ADDINFO2.equalsIgnoreCase("30 Pages Cheque Book") && INPUT.equalsIgnoreCase("1") ) {
								flag = true;
								details = Cheque_Book_Request(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0013") && ADDINFO2.equalsIgnoreCase("60 Pages Cheque Book") && INPUT.equalsIgnoreCase("2") ) {
								flag = true;
								details = Cheque_Book_Request(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M011") && ADDINFO2.equalsIgnoreCase("Account Statement") && INPUT.equalsIgnoreCase("5") ) {
								flag = true;
								details = Account_Statement(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0014") && ADDINFO2.equalsIgnoreCase("Current Month") && INPUT.equalsIgnoreCase("1") ) {
								flag = true;
								details = Account_Statement(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0014") && ADDINFO2.equalsIgnoreCase("Previous Month") && INPUT.equalsIgnoreCase("2") ) {
								flag = true;
								details = Account_Statement(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0014") && ADDINFO2.equalsIgnoreCase("Last three Month") && INPUT.equalsIgnoreCase("3") ) {
								flag = true;
								details = Account_Statement(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0014") && ADDINFO2.equalsIgnoreCase("Last six Month") && INPUT.equalsIgnoreCase("4") ) {
								flag = true;
								details = Account_Statement(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0014") && ADDINFO2.equalsIgnoreCase("Annual Statement") && INPUT.equalsIgnoreCase("5") ) {
								flag = true;
								details = Account_Statement(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M011") && ADDINFO2.equalsIgnoreCase("Bill Payments") && INPUT.equalsIgnoreCase("6") ) {
								flag = true;
								details = Bill_Payments(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0015") && ADDINFO2.equalsIgnoreCase("Electricity Bill") && INPUT.equalsIgnoreCase("1")) {
								flag = true;
								details = Bill_Payments(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0015") && ADDINFO2.equalsIgnoreCase("Income Tax") && INPUT.equalsIgnoreCase("2")) {
								flag = true;
								details = Bill_Payments(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0015") && ADDINFO2.equalsIgnoreCase("Telephone Bill") && INPUT.equalsIgnoreCase("3")) {
								flag = true;
								details = Bill_Payments(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00013") && ADDINFO2.equalsIgnoreCase("Enter the Invoice or Control Number")) {
								flag = true;
								details = Bill_Payments(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M00015") && ADDINFO2.equalsIgnoreCase("Enter the Input '1' for confirm the payment") && INPUT.equalsIgnoreCase("1")) {
							...
							if (SERCODE.equalsIgnoreCase("M00015") && ADDINFO2.equalsIgnoreCase("Enter the Input '2' for Cancel the payment") && INPUT.equalsIgnoreCase("2")) {
								flag = true;
								details = Bill_Payments(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
			        ...
			        //New registration//				
							...
							if (SERCODE.equalsIgnoreCase("M00016") && INPUT.equalsIgnoreCase("1") && ADDINFO2.equalsIgnoreCase("Accept")) {
								flag = true;
								details = New_Registration(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0019") && ADDINFO2.equalsIgnoreCase("Please enter your full name")) {
								flag = true;
								details = New_Registration(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
							if (SERCODE.equalsIgnoreCase("M0020") && ADDINFO2.equalsIgnoreCase("Please enter your Date Of Birth")) {
								flag = true;
								details = New_Registration(MOBILENO,CHCODE,SERCODE,INPUT,ADDINFO1,ADDINFO2,ADDINFO3,commdate,commtime,Session_Id);
							}
...
//							}
							...
							if(flag == true) {
//										String RESMSG = "";  String SELECTCD = "";
//										
//										if (INPUT.equalsIgnoreCase("1") || INPUT.equalsIgnoreCase("2") || INPUT.equalsIgnoreCase("3") ||INPUT.equalsIgnoreCase("4") || INPUT.equalsIgnoreCase("5") ||  INPUT.equalsIgnoreCase("6") || INPUT.equalsIgnoreCase("7") || INPUT.equalsIgnoreCase("8") || INPUT.equalsIgnoreCase("9")) {
//											SELECTCD = INPUT ;
//											RESMSG = INPUT;
//										} else {
//											SELECTCD = "01";
...
//										System.out.println("RESMSG"+SELECTCD);
		...
		public JsonObject Existing_Customer(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
		{
			...
			JsonObject details = new JsonObject();
					...
					if (SERCODE.equalsIgnoreCase("M013")) {                
						menucode1 = "M0017";							  					  //Existing Customer
					} 
					else if (SERCODE.equalsIgnoreCase("M0017")) {
						menucode1 = "M00018"; 							  					   //Enter the PIN
					} 
					else if (SERCODE.equalsIgnoreCase("M00018")) {
						if (INPUT.equalsIgnoreCase("1234")) {
							menucode1 = "M011"; 							 					//All services
						} else {
							menucode1 = "M014"; 							  					//Invalid PIN
						}
					} 
			...
			if (SERCODE.equalsIgnoreCase("M013"))   {
							...
							{	
								  JsonArray js = new JsonArray();
								   ...
								   List<Menu008>  Info1 = Jdbctemplate.query(sql1, new Object[] { CHCODE, menucode1  } ,new Menu008Mapper ());
								   ...
								   for (int i=0; i<Info1.size(); i++) {
									    ...
									    Insert_bot003(SUBORGCODE,CHCODE,commdate,MOBILENO,ADDINFO1,Session_Id,commtime,Info1.get(i).getM2CODE(),Info1.get(i).getMENUSL(),Info1.get(i).getMENUDESC()); //Adding Response in bots004 
			...
			if (SERCODE.equalsIgnoreCase("M0017"))   {
			...
			if (SERCODE.equalsIgnoreCase("M00018")) {
						...
						{	
								...
								JsonArray js = new JsonArray();
										...
										{					
										    ...
										    Insert_bot003(SUBORGCODE,CHCODE,commdate,MOBILENO,ADDINFO1,Session_Id,commtime,Info.get(i).getM1CODE(),Info.get(i).getMENUSL(),Info.get(i).getMENUDESC()); //Adding Response in bots004 
		...
		public JsonObject New_Registration(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
		{
			...
			JsonObject details = new JsonObject();
				...
				String menucode1 = "";  String menucode2 = "";
					...
					else if (SERCODE.equalsIgnoreCase("M0019")) {     // Terms and conditions
						menucode1 = "M0020";           
					}
					else if (SERCODE.equalsIgnoreCase("M0020")) {     // Terms and conditions
						menucode1 = "M0022";           
					}
...
//											Timestamp commtime1 = util.get_oracle_Timestamp();
				 ...
				 if (SERCODE.equalsIgnoreCase("M0019")) {
...
//											Timestamp commtime1 = util.get_oracle_Timestamp();
				 ...
				 if (SERCODE.equalsIgnoreCase("M0020")) {
					...
					if (SERCODE.equalsIgnoreCase("M011")) {
						...
						{	
							//Insert_bot003(SUBORGCODE,CHCODE,commdate,MOBILENO,COUNTRYCD,sessionid,commtime,SERCODE,SELECTCD,REQMSG); //Adding Request in bots003 
								...
								List<IPS_ACCOUNT_VIEW001>  Info = Jdbctemplate.query(sql, new Object[] { MOBILENO, ADDINFO1 } ,new IPS_ACCOUNT_VIEW001Mapper ());
								...
								if (Info.size() != 0) {
				                    ...
				                    JsonObject job = new JsonObject();
//									
//									job.addProperty("Serial","Account No"+Info.get(0).getACCNO());
//									job.addProperty("SERCODE","Mobile No"+Info.get(0).getMOBILENO());
//									job.addProperty("DESCRIPTION","Available Balance "+Info.get(0).getCURRENCY()+"."+Info.get(0).getBALANCE());
//												
				                    String serial_no = "1";
				                    String sercode = "M00BE";
...
//									}
		...
		public JsonObject Transfer(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
		{
			...
			JsonObject details = new JsonObject();
						...
						else if (SERCODE.equalsIgnoreCase("M00014") && ADDINFO2.equalsIgnoreCase("Enter the Destination Bank Code") ) {
							menucode1 = "M00014";							  					 
							MENUSL = "1";
						}
						else if (SERCODE.equalsIgnoreCase("M00014") && ADDINFO2.equalsIgnoreCase("Enter the Destination Account Number") ) {
							menucode1 = "M00014";							  					 
							MENUSL = "2";
						}
						else if (SERCODE.equalsIgnoreCase("M00014") && ADDINFO2.equalsIgnoreCase("Enter the Transaction Amount") ) {
							menucode1 = "M00014";		
							menucode2 = "M00014C"; 
							MENUSL = "3";
						}
						else if (SERCODE.equalsIgnoreCase("M00014") && ADDINFO2.equalsIgnoreCase("Select the Transaction Currency") ) {
							menucode1 = "M00014"; 
							//MENUSL = "4";
						}
						...
						else if (SERCODE.equalsIgnoreCase("M000013") && ADDINFO2.equalsIgnoreCase("Enter the OTP") ) {
							if (INPUT.equalsIgnoreCase("1234")) {
								menucode1 = "M000011"; 							 					//All services
							} else {
								menucode1 = "M000014"; 							  					//Invalid PIN
							}
						}
						...
						else if (menucode1.equalsIgnoreCase("M00014")) {
					...
					{	
							...
							for (int i = 0; i< Info.size(); i++ ) {
								...
								job.addProperty("Serial",Info.get(i).getMENUSL());
								job.addProperty("SERCODE",Info.get(i).getM4CODE());
								job.addProperty("DESCRIPTION",Info.get(i).getMENUDESC());
														
							    Insert_bot003(SUBORGCODE,CHCODE,commdate,MOBILENO,ADDINFO1,Session_Id,commtime,Info.get(i).getM4CODE(),Info.get(i).getMENUSL(),Info.get(i).getMENUDESC()); //Adding Response in bots004 
				...
				else if (SERCODE.equalsIgnoreCase("M00014")){
				...
				else if (SERCODE.equalsIgnoreCase("M000013")){ 
		...
		public JsonObject Cheque_Book_Request(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
		{
			...
			JsonObject details = new JsonObject();
						...
						if (SERCODE.equalsIgnoreCase("M011") && ADDINFO2.equalsIgnoreCase("Cheque Book Request")) {                
							...
							menucode1 = "M00011";							  					  //Existing Customer
						}
		...
		public JsonObject Bill_Payments(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
		{
			...
			JsonObject details = new JsonObject();
						...
						else if (SERCODE.equalsIgnoreCase("M00013")) {                
							invoice = INPUT;	
							menucode1 = "M00015";
						}
				...
				if (SERCODE.equalsIgnoreCase("M00013") && INPUT.equalsIgnoreCase(invoice)) {
					...
					{	
						...
						JsonArray js = new JsonArray();
			                    ...
			                    String bill_desc = "Bill No "+Info.get(0).getBILL_NO()+" "+"Bill Amount "+Info.get(0).getBILL_AMOUNT()+" TZS";
		...
		public JsonObject Main_Menu(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
		{
	...
	//*****************************   Main Menu1 *********************************//
		...
		public JsonObject Main_Menu1(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
		{
		...
		public JsonObject Get_data_bots004(String MOBILENO,String CHCODE,String SERCODE,String INPUT,String ADDINFO1,String ADDINFO2,String ADDINFO3,String commdate,Timestamp commtime,String Session_Id) 
	{
		...
		public JsonObject Interaction_Session() 
		{
			...
			{	
						...
						String sql1 = "SELECT COUNT(DISTINCT SESSIONID) FROM bots004";
