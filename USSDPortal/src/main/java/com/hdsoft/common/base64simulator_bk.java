...
@Component
public class base64simulator_bk 
{
	...
	private final  static Logger logger = Logger.getLogger(base64simulator_bk.class);
	...
	{
		//formrequest("10000","0","174","5407195239", "5405616121", "narration", "SYNOD", "0000000000000002");
	}
...
/*	public static void getlen(String DCCHN) throws Exception
	{
		ResultSet rset = null ;
		...
		try{
			...
			"jdbc:oracle:thin:@localhost:1521:ORACLEDB","intouch2","nopassword");  
			
			
			
			pstmt = con.prepareStatement("SELECT *  " +
					" from NVILENDEF where SUBORGCODE='EXIM' and CHANNEL='EB' and ICDCODE = 'ISO' and STATUS =1");
	    	...
	    	if(rset.next()){
	    		...
	    		{
	    			j=i+1;
	    			String DE = (rset.getString("NVI"+j).trim());
	    			System.out.println(j + " j - i " +i + " data " + DE);
	...
	public static String formrequest(String amount,String chargeamt, String cur,String souraccount, String Destinationno, String NARR, String REQCODE, String brncode)
	{
