...
<%@ include file="../../../Headers_&_Footers/PULSE/Home/CSS_&_JS2.jsp" %>   
					...
					<div class="row">
						<div class="col-md-6">
							<div class="card full-height">
								...
								<div class="card-body">
									<div class="mb-4 mt-2">
										<div class="card-title"><h1>4,578.58</h1></div>
									</div>
									<div class="pull-in">
						...
						<div class="col-md-6">
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title"><h4 class="mt-3 b-b1 pb-2 mb-4 fw-bold">Active user right now</h4></div>
									<div class="card-title"><h1 class="mb-4 fw-bold">17</h1></div>
									<div class="card-title"><h4 class="mt-3 b-b1 pb-2 mb-5 fw-bold">Page view per minutes</h4></div>
