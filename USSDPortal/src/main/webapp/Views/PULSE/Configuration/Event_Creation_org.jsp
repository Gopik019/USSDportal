						...
						<div id="colour_body" class="card">
							...
							<div id="tab_card" class="card-body">
									...
									<div class="row">	
										<div class="col-md-2">
											<div class="form-group">	
												<label for="email2">Frequency Sub Type</label>
											</div>
										</div> 
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">	
												<input id="holiday_exec" type="checkbox" class="form-control">    
										...
										<div class="col-md-4">
											<div class="form-group">		
												<input id="weekend_exec" type="checkbox" class="form-control"> 	
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">	
												<input id="sys_stats_check" type="checkbox" class="form-control">    
										...
										<div class="col-md-4">
											<div class="form-group">		
												<input id="enabled_disabled" type="checkbox" class="form-control"> 	
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">	
												<input id="pre_check" type="checkbox" class="form-control">    
										...
										<div class="col-md-4">
											<div class="form-group">		
												<input id="par_event" type="checkbox" class="form-control"> 	
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">		
												<input id="dup_check" type="checkbox" class="form-control"> 	
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">		
												<input id="sms_req" type="checkbox" class="form-control"> 	
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">	
												<input id="email_req" type="checkbox" class="form-control">    
										...
										<div class="col-md-4">
											<div class="form-group">		
												<input id="call_req" type="checkbox" class="form-control"> 	
									...
									<div id="sql_api" class="row">	
										...
										<div id="sql_config" class="col-md-2">
											<div class="form-group">	
												<label for="email2">SQL ID</label>
											</div>
										</div> 
									
										<div id="sql_config_" class="col-md-4">
											<div class="row">	
												<div class="col-md-6">
													<div class="form-group">	
											...
											<div id="api_config" class="col-md-2">
												<div class="form-group">	
													<label for="email2">API ID</label>
												</div>
											</div>
										
											<div id="api_config_" class="col-md-4">
												<div class="row">	
													<div class="col-md-6">
														<div class="form-group">	
