							...
							<div class="card">
								...
								<div class="card-body">
										...
										<div class="col-md-4">
											<div class="form-group">		
												<select id="i_paytype" class="form-control">
													...
													<option value="CTR">Currency (Cash) Transactions</option>
													<option value="OFT">Outward Fund Transfer Transactions</option>	
													<option value="IFT">Inward Fund Transfer Transaction</option>				
													<option value="EFT">Electronic Fund Transfer Transaction</option>					
												</select>
									...
									<div class="row">	
										...
										<div class="col-md-4">
											<div class="form-group">		
												<textarea rows="4" class="form-control" id="i_reason" placeholder=""></textarea>
										...
										<div class="col-md-4">
											<div class="form-group">		
												<textarea rows="4" class="form-control" id="i_action" placeholder=""></textarea>
								...
								<div class="card-action">
									<div class="row">	
										...
										<div class="col-md-1">
											<button id="generate" class="btn btn-indigo">Generate</button>
										</div>
										<div class="col-md-2">
											<button id="view" class="btn btn-indigo" data-toggle="modal" data-target="#Modal2">View Report</button>
										</div>
