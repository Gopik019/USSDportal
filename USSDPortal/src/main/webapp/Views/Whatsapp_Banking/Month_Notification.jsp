...
<%@ include file="../../../Headers_&_Footers/Whatsapp_Banking/CSS & JS4.jsp" %>
...
<body data-background-color="${Menu.get('body_color').getAsString()}">   
    ...
    <div class="main-panel">
		...
		<div class="container pb-5">
			<div class="row mt-5">
				<h3 style="padding-left: 35%">Whatsapp Month Notification</h3><br>
				<div class="col-12">
					<div class="col-md-12">
							  ...
							  datasets: [
								{
								  ...
								  borderColor: '#007bff',
								  data: [1, 2, 3, 3, 4, 5, 6, 7, 8,1, 2, 3, 3, 4, 5, 6, 7, 8,1, 2, 3, 3, 4, 5, 6, 7, 8,1,2,3]
								},
								{
								  label: "Image Notification",
								  backgroundColor: '#007bff', 
								  borderColor: '#ced4da',
								  data: [2, 6, 2.5, 1.5, 3, 4, 3.5, 4.5, 7,2, 6, 2.5, 1.5, 3, 4, 3.5, 4.5, 7,2, 6, 2.5, 1.5, 3, 4, 3.5, 4.5, 7,2,6,2.5]
								},
								{
								  label: "Text Notification",
								  backgroundColor: '#ced4da',
								  borderColor: '#007bff',
								  data: [3, 5, 7, 4, 6, 7, 4, 8, 9,3, 5, 7, 4, 6, 7, 4, 8, 9,3, 5, 7, 4, 6, 7, 4, 8, 9,3,5,7]
								},
							  ]
							},
							options: {
