	...
	<div class="container login_box">
		<div class="row">
			<div class="col-sm-6 loginimage">
				<img src="<spring:url value="/resources/WHATSAPP/img/ussd_gif5.gif" />" />
			</div>
					...
					<form id="loginForm" action="<%= request.getContextPath() %>/HDPAY/login" method="post">
					  ...
					  <div class="container">
						...
						<div id="c_logo" class="row mt--3 mb-3">
							...
							<div class="col col-sm-4"><img src="<spring:url value="/resources/WHATSAPP/img/ussd_logo.jpeg" />" /></div>
							<div class="col col-sm-4"></div>
						</div> 
					  ...
					  <div class="container foot">
						<div class="row">
						   ...
						   <div class="col-sm-4 ml-3 mt-4 ">
							...
							<a href="<%= request.getContextPath() %>/HDPAY/ForgetPassword" id="forgetpass" class="stretched-link text-primary" style="position: relative;">Forget Password</a>
