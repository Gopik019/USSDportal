...
<body>
					...
					<div class="col-md-12 mt--1">
							<div id="colour_body" class="card">
										...
										<div class="col-md-3">
											<div class="form-group">
												<select id="tbublock" class="form-control">
													...
													<option value="1" id="block">Block</option>
													<option value="0" id="unblock">UnBlock</option>
												</select>
								...
								<div class="card-action">
									<div class="row">										
										<div class="col-md-6">
											<button class="btn btn-secondary float-right" id="proceed">Submit</button>	
										</div>
										<div class="col-md-6">	
	...
	var jspath="<%=path%>" ;
	var serbasePath="<%= request.getContextPath() %>";
	
	$(document).ready(function() {
		//alert(serbasePath);
		
		 $("#tuserid").autocomplete({
			    source:  serbasePath + 	"/HDPAY/Suggestions/Unblock/User_Id",			//"/Suggestions/Unblock/User_Id",
			    minLength: 1,			
			   ...
			   /* {
			    ...
			    
			    {
			    	 if(ui.item)
			    		 ...
			    		 {
			    		 	$("#tuserid_error").html('This User Id Not Found');
							$("#tuserid_error").show();
	...
	function proceed()
	{
	   ...
	   $.ajax({		 
			url  :  serbasePath + "/HDPAY/Block_Unblock_User",
			type :  'POST',
			data :  data,
			cache : false,
			contentType : false,
	...
	function QUEUECHECKER()
	{
	   ...
	   $.ajax({		 
			url  :  serbasePath + "/HDPAY/QUEUECHECKER",
			type :  'POST',
			data :  data,
			cache : false,
			contentType : false,
