<title>${Menu.get('Title').getAsString()}</title>
	...
	<link href='<spring:url value="/resources/HDPAY/css/select.dataTables.min.css" />' rel="stylesheet">	
	...
	<script type="text/javascript" src='<spring:url value="/resources/HDPAY/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js"/>' ></script>
 	<script type="text/javascript" src='<spring:url value="/resources/HDPAY/Validations/Administration/User_Password.js" />' ></script>
