<title>${Menu.get('Title').getAsString()} </title>
	...
	<script type="text/javascript" src='<spring:url value="/resources/HDPAY/Validations/Others/Session_Management.js" />' ></script> 
	<script type="text/javascript" src='<spring:url value="/resources/HDPAY/Validations/Login/Time_Out.js" />' ></script>	
	<script type="text/javascript" src='<spring:url value="/resources/HDPAY/Validations/Administration/Profile_Image.js" />' ></script> 
