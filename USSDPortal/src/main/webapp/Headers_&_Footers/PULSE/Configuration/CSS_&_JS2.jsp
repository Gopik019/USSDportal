<title>Configuration</title>
	...
	<link href='<spring:url value="/resources/PULSE/css/form_wizards/style.css" />' rel="stylesheet"> 
	...
	<script type="text/javascript" src='<spring:url value="/resources/PULSE/js/form_wizards/jquery.steps.js"/>' ></script>
	<script type="text/javascript" src='<spring:url value="/resources/PULSE/js/form_wizards/jquery-ui.min.js"/>' ></script>
	<script type="text/javascript" src='<spring:url value="/resources/PULSE/js/form_wizards/main.js"/>' ></script>  
  	<script type="text/javascript" src='<spring:url value="/resources/PULSE/Validations/Configuration/Threads.js" />' ></script> 
