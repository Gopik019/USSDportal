<title>Configuration</title>
	...
	<link href='<spring:url value="/resources/PULSE/css/autocomplete.css" />' rel="stylesheet">
	...
	<script type="text/javascript" src='<spring:url value="/resources/PULSE/Validations/Configuration/Alert_distribution.js" />' ></script> 
 	<script type="text/javascript" src='<spring:url value="/resources/PULSE/Validations/Configuration/Event_Creation.js" />' ></script> 
