$(document).ready(function() {
	...
	var table = $('#example').DataTable();   //http://pdfmake.org/#/gettingstarted
	...
	$("#i_reason").blur(function() {
		Valid_Reason();
	});
	
	$("#i_action").blur(function() {
		Valid_Action();
	});
